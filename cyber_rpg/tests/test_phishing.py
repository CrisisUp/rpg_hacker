...
from systems.script_effects import _run_social_engineering_game, PhishingScenario, PhishingOption
...
class TestPhishing(unittest.TestCase):
    ...
    def test_phishing_success(self, mock_choice, mock_ask):
        ...
        mock_choice.return_value = PhishingScenario(
            persona="Test", context="Test", prompt="Test",
            options=[PhishingOption(text="Success", success=True, trace=10)]
        )
    ...
    def test_phishing_failure(self, mock_choice, mock_ask):
        ...
        mock_choice.return_value = PhishingScenario(
            persona="Test", context="Test", prompt="Test",
            options=[PhishingOption(text="Fail", success=False, trace=20)]
        )
